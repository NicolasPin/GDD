...
BEGIN
    ...
    -- Eliminar los caracteres que no son números usando REPLACE
...
--Genera un legajo unico y autoincremental
...
--generar secuencia para el pago_numero
...
--crar secuancia para el codigo de envio
...
--crear secuencia para el deta_codigo
