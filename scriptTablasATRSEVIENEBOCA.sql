...
create table [MASTER_COOKS].[Rebaja_producto] (
    reba_producto_id decimal(18,0) primary key,
    reba_promocion_id decimal(10,2),
    reba_prod_promocion_aplicada decimal(10,2),
...
create table [MASTER_COOKS].[Item_Ticket] (
    item_tipo_id char(1),
    item_sucursal_id decimal(18,0),
    item_numero_id decimal(18,0),
    item_producto_id decimal(18,0),
    item_cantidad decimal(18,2),
...
create table [MASTER_COOKS].[Promocion_X_Ticket] (
    promx_promocion_id decimal(18,0),
