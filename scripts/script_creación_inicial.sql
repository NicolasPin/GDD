...
CREATE FUNCTION dbo.devolverImporteDeCuotas (@importe DECIMAL(18,2), @cuotas VARCHAR(60))
...
CREATE FUNCTION dbo.devolverTurno(@FECHA DATETIME)
RETURNS CHAR(12)
AS
BEGIN
...
FROM gd_esquema.Maestra
WHERE CONCAT(TICKET_NUMERO, ENVIO_FECHA_ENTREGA) IS NOT NULL AND ENVIO_ESTADO IS NOT NULL;
