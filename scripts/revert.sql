...
DROP TABLE IF EXISTS MASTER_COOKS.BI_Fact_Cuotas;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Fact_Envio;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Fact_Descuento;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Fact_Ventas;

-- Eliminar dimensiones
DROP TABLE IF EXISTS MASTER_COOKS.BI_Dim_Caja;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Dim_Ticket;
...
DROP TABLE IF EXISTS MASTER_COOKS.BI_Dim_Cliente_Localidad;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Dim_Cliente;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Dim_Localidad;
DROP TABLE IF EXISTS MASTER_COOKS.BI_Dim_Provincia;
